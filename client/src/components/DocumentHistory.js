          ...
          <Container>
            {activeDocuments.map((document) => (
              <Row key={`history-entry-${document._id}`} className="mb-4">
                ...
                <Col>
                  <ButtonToolbar>
                    <Button variant="outline-dark" className="mr-2" onClick={() => window.open('http://localhost:5000/api/pdf/'+document._id, '_blank')}><span className="mr-1"><GetAppIcon /></span>Download</Button>
